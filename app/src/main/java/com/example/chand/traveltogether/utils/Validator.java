...
public class Validator {
     ...
     * 正则表达式：验证密码
     */
    public static final String REGEX_USERNUM = "^[a-zA-Z0-9.,;'{}\\[\\]\\-_=+~!@#$%^&*()]{8,20}$";
    ...
    public static final String REGEX_AGE = "^[1-9]([0-9])?$";
     ...
     * @return 校验通过返回true，否则返回false
     */
    public static boolean isUserPass(String USERNUM) {
        return Pattern.matches(REGEX_USERNUM, USERNUM);
    }
