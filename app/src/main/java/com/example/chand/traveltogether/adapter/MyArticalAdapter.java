...
public class MyArticalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<ArticalEntity> articals;
    private LayoutInflater mInflater;
    private MyArticalAdapter.OnItemClickListener onItemClickListener;
    private final int NO_DATA = 0, OFFICIAL = 1, UNOFFICIAL = 2;
    private WeakReference<Context> mcontext;

    public MyArticalAdapter(List<ArticalEntity> list, Context context) {
        articals = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            case NO_DATA:
                mHolder = new MyArticalAdapter.ImageViewHolder(mInflater.inflate(R.layout.cardview_nodata_artical, viewGroup, false));
                break;
            case OFFICIAL:
                mHolder = new MyArticalAdapter.ImageViewHolder(mInflater.inflate(R.layout.cardview_official, viewGroup, false));
                break;
            case UNOFFICIAL:
                mHolder = new MyArticalAdapter.UnOfficialHolder(mInflater.inflate(R.layout.cardview_unofficial_artical, viewGroup, false));
                break;
            default:
                mHolder = new MyArticalAdapter.ImageViewHolder(mInflater.inflate(R.layout.cardview_nodata_artical, viewGroup, false));
                break;
...
//        }
    ...
    public void setOnItemClickListener(MyArticalAdapter.OnItemClickListener onItemClickListener) {
